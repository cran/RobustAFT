...
\arguments{
  \item{x}{ An object of class "TML", usually, a result of a call to \code{\link{TML.noncensored}} or \code{\link{TML.censored}}.}
  \item{which}{ If a subset of the plots is required, specify a subset of the numbers \code{1:3}.}
...
\details{
      The residual Q-Q plot is build with respect to the \code{errors} argument of the object. 
...
\seealso{ \code{\link{TML.noncensored}}, \code{\link{TML.censored}}, \code{\link[graphics]{plot.default}}}
