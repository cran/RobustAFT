...
i1   <- beta^2*(RobustAFT:::pezez(u)-RobustAFT:::pezez(l))
i2   <- integrate(RobustAFT:::s2s2phi.w,lower=l,upper=u)$value
i3   <- integrate(RobustAFT:::s2phi.w,lower=l,upper=u)$value
Ex   <- as.matrix(xbar)
